<?php 
//namespace App\Library\JackApi\pages;
use App\Library\JackApi\eveApi\eveApiSkills;
use App\Library\JackApi\eveApi\eveApiTraining;
...
EOD;
			...
			$this->Output="<table class=\"skills_table table\"><tr VALIGN=\"top\">";		
			$small =1;
			if ($small) {
				 echo "<td VALIGN=\"top\" width=\"250\" rowspan=\"2\">\n";
				 include("skills/skills.tab.php");
				 echo "</td>\n<td VALIGN=\"top\">\n"; /////////////////////////////////////////////////////
				 include("skills/racial.tab.php");
				 echo "</td>\n<td VALIGN=\"top\">\n"; /////////////////////////////////////////////////////
				 include("skills/caps.tab.php");
				 echo "<td VALIGN=\"top\">\n"; /////////////////////////////////////////////////////
				 include("skills/weaps.tab.php");
				 echo "</td>\n<td VALIGN=\"top\">\n"; /////////////////////////////////////////////////////
				 include("skills/fleet.tab.php");
				 echo "</td></tr>\n<tr>";
				 echo "<td VALIGN=\"top\">\n"; /////////////////////////////////////////////////////
				 include("skills/skillst2.tab.php");
				 echo "</td>\n<td VALIGN=\"top\">\n"; /////////////////////////////////////////////////////
				 include("skills/ldrskil.tab.php");
				 echo "</td>\n<td VALIGN=\"top\">\n"; /////////////////////////////////////////////////////
				 include("skills/t2mods.tab.php");
				 echo "</td>\n<td VALIGN=\"top\">\n"; /////////////////////////////////////////////////////
				 include("skills/misc.tab.php");
			} else {
